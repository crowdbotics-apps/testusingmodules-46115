"""
Django settings for testusingmodules_46115 project.
...
ROOT_URLCONF = 'testusingmodules_46115.urls'
...
WSGI_APPLICATION = 'testusingmodules_46115.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testusingmodules_46115 API",
    "DESCRIPTION": "API documentation for testusingmodules_46115 App",
    "VERSION": "v1",
}
